...
//процедура сохранения информации из таблицы в файл
procedure SaveTable(Table: TStringGrid; str : string);
var
  i, j: integer;
begin
...
//процедура сохранения данныз из поля в файл
procedure SaveEdit(Edit : TEdit);
begin
  if n = 0 then
    assignfile(f, way + 'Результаты вычислений.txt')
...
//процедуоа провери ячеек таблицы на корректность
procedure CheckString(var Table : TStringGrid; i, j: integer; var flag : boolean);
var
  k, x : integer;
  curr : string;
...
//процедуоа провери поля на корректность
procedure CheckEdit(var Edit : TEdit;  var flag : boolean);
var
  k, x : integer;
  curr : string;
...
//процедура очистки всех ячеек таблицы
procedure Clean(Table : TStringGrid);
var
  i :integer;
begin
...
//процедура преобразования информации из поля в нужный тип
procedure SetEdit(Edit : TEdit; var size : integer);
begin
